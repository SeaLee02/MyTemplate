...
namespace WebApiOwin.Model
{
    public class ConfigHelper
    {
        ...
        {
            SigningCredentials result = new SigningCredentials(GetSymmetricSecurityKey(), SecurityAlgorithms.HmacSha256);
            return result;
        }
        ...
        {
            string issuerSigningKey = GetSecurityKey();
        ...
        public static SymmetricSecurityKey GetSymmetricSecurityKey()
        {
            ...
            SymmetricSecurityKey result = new SymmetricSecurityKey(data);
            return result;
        }
